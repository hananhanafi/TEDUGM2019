<p id="gmbr"><img
    src="<?php echo base_url() ?>assets/images/science_project.png"
    height="300px"
    width="300px"></p>
...
<form
    id="formRegister"
    action="<?= site_url('auth/competition_register') ?>"
    method="POST">
    <div class="form-group">
        <label for="team">Cabang Lomba</label>
        <select class="form-control" name="cabor">
            <option disabled="disabled" selected="selected">Pilih Lomba</option>
    ...
    <div class="form-group">
        ...
        <input
            ...
            name="instansi"
            id="Instansi"
            placeholder="Nama Instansi (kosongkan untuk umum)"
            value="<?php echo set_value('instansi') ?>"/>
...
<div class="form-group">
    ...
    <input
        ...
        value="<?php echo set_value('ketua') ?>"
        required="required"/>
...
<input
    ...
    name="pendamping"
    id="Pendamping"
    placeholder="Nama Pendamping (kosongkan untuk umum)"
    value="<?php echo set_value('pendamping') ?>"/>
